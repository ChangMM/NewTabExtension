          ...
          <div class="nav-content clearfix">
            <div class="setting-content">
              ...
              <div class="zan-wrap">
                ...
                <img class="zan-img" src="https://cdn.Iizhi.cn/zan.png" alt="">
              </div>
...
export default {
  ...
  mounted() {
    try{
      chrome.storage.sync.get('nickname', (value) => {
...
#setting{
  ...
  .header{
    ...
    .close{
      ...
      background-image: url('https://cdn.Iizhi.cn/icons/close.png');
      transition: all ease 0.2s;
      &:hover{
        background-image: url('https://cdn.Iizhi.cn/icons/close-hover.png');
      }
    }
    ul{
      list-style: none;
      ...
      li{
        ...
        &:hover, &.active{
          color: #333;
          .daohang{
            background-image: url('https://cdn.Iizhi.cn/icons/daohang-hover.png');
          }
          .bizhi{
            background-image: url('https://cdn.Iizhi.cn/icons/bizhi-hover.png');
          }
          .jishi{
            background-image: url('https://cdn.Iizhi.cn/icons/jishi-hover.png');
          }
          .shezhi{
            background-image: url('https://cdn.Iizhi.cn/icons/setting-black-hover.png');
          }
        }
        .icon{
          display: inline-block;
        ...
        .daohang{
          background-image: url('https://cdn.Iizhi.cn/icons/daohang.png');
        }
        .bizhi{
          background-image: url('https://cdn.Iizhi.cn/icons/bizhi.png');
        }
        .jishi{
          background-size: 14px;
          background-image: url('https://cdn.Iizhi.cn/icons/jishi.png');
        }
        .shezhi{
          background-image: url('https://cdn.Iizhi.cn/icons/setting.png');
        }
        span{
          display: inline-block;
          width: 100%;
